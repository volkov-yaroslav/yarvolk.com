...
<figure class="my-8 rounded-lg border border-black/10 bg-black/5 p-4">
  <img
    ...
    src="/images/blog/generate-press-codex-1.webp"
    alt="Codex app interface selecting a WordPress stack and planning the project setup."
    width="1600"
    height="960"
  />
  <figcaption class="mt-3 text-sm uppercase tracking-wide text-black/55">
    Codex choosing the GeneratePress and GenerateBlocks direction for a real WordPress project.
  </figcaption>
</figure>
...
<figure class="my-8 rounded-lg border border-black/10 bg-black/5 p-4">
  ...
  />
  <figcaption class="mt-3 text-sm uppercase tracking-wide text-black/55">
    GenerateBlocks editor output after Codex builds the section structure inside WordPress.
  </figcaption>
</figure>
