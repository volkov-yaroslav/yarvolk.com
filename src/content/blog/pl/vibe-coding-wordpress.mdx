...
description: "Agenci AI i WP-CLI zmieniają to, jak planuję, przygotowuję strukturę i buduję strony WordPress, i nie sądzę, żebym chciał wracać do starego podejścia."
...
W 2026 roku słowo *ręcznie* zaczyna znikać z mojego sposobu pracy, a projekt klientowski taki jak [Happy Mortgage](/pl/portfolio/happy-mortgage) był momentem, w którym poczułem tę zmianę w praktyce.
...
<figure class="my-8 rounded-lg border border-white/15 bg-white/5 p-4">
  <img
    ...
    alt="Efekt w edytorze WordPress po tym, jak Codex zbudował strukturę sekcji w GenerateBlocks."
    width="1600"
    height="960"
  />
